...
> TideGuard AI Team (2026). *TideGuard: a Physics-Informed Neural Network for marine debris forecasting and community action.* Open-source release v0.1. https://github.com/Doorphospigot4/tqtgfgpk
